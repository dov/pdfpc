...
namespace pdfpc.Drawings.Storage {
    ...
    public abstract class Base {
        ...
        public abstract void store(uint index,
                                   DrawingCommands.DrawingCommandList drawing_commands);
        /**
         ...
         */
        public abstract pdfpc.Drawings.DrawingCommands.DrawingCommandList? retrieve(uint index);
    ...
    public class MemoryUncompressed : Drawings.Storage.Base {
         ...
         */
        protected DrawingCommands.DrawingCommandList[] drawing_commands_storage = null;
        ...
        public override pdfpc.Drawings.DrawingCommands.DrawingCommandList? retrieve(uint index) {
        ...
        public override void clear() {
            // This was the old comment. Not sure it makes sense...
            ...
            // changing.
            drawing_commands_storage = new pdfpc.Drawings.DrawingCommands.DrawingCommandList[this.metadata.get_slide_count()];
        }
    }
